...
`timescale 1 ps / 1 ps
module nios_system_intel_niosv_g_0 (
	...
	nios_system_intel_niosv_g_0_hart #(
	...
	nios_system_intel_niosv_g_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	nios_system_intel_niosv_g_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	nios_system_intel_niosv_g_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
