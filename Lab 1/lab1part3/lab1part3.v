module lab1part3 (
	...
	wire [3:0]off = 4'b1111;		// off input
	wire [3:0]key_counter_val;		// button counter output
	wire [29:0]clock_counter_val;	// clock counter output
